...
public class Done extends Fragment {
    ...
    private void getCurrentOrders() {
        ...
        String url = "https://zarmie.co.za/api/get-accepted-orders";
        if(!refreshing){
            showProgress(true);
        }
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (response_obj.length() > 0) {
                        ...
                        mAdapter = new AcceptedOrdersAdapter(orderList,getContext());
                        ...
                        Toast.makeText(getContext(), " There are no done orders at the moment", Toast.LENGTH_LONG).show();
                    }
