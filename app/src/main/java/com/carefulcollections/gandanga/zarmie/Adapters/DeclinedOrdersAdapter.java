...
public class DeclinedOrdersAdapter extends RecyclerView.Adapter<DeclinedOrdersAdapter.MyViewHolder> {

    private final List<Order> orderList;
    Context context;

    public DeclinedOrdersAdapter(List<Order> orderList,Context context) {
